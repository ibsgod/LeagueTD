...
class MasterYi(Champion):
    def __init__(self, x, y, summ=False, hp=None, mana=None):
        super().__init__(x, y, summ, name="Master Yi", hp=8, mana=10, atk=1, atkrange=50, atkspd=0.5, be=10, ranged=False, block=2)
        self.passName = "Double Strike"
        self.passDesc = "Hits twice every 4th attack"
        self.actName = "Alpha Strike"
        self.actDesc = "Becomes invincible and strikes nearby enemies (Always in alpha)"
